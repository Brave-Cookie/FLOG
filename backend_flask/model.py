...
class LogInfo(db.Model):
    ...
    idx = db.Column(db.Integer, primary_key=True)
    log_realtime = db.Column(db.Integer, nullable=False)
...
class TempRoomInfo(db.Model):
    __tablename__ = 'temp_room_info'

    room_code = db.Column(db.String(45), primary_key=True)
    meeting_name = db.Column(db.String(20), nullable=False)
